...
make -f simd_make_arm.mk build
make -f simd_make_m32.mk build
make -f simd_make_p32.mk build
make -f simd_make_a64.mk build
make -f simd_make_m64.mk build
make -f simd_make_p64.mk build
