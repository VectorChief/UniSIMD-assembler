...
# fully successful test pass results in test86 file of  22195 bytes (36 tests)
# test pass on AVX2-only CPU results in test86 file of  17354 bytes (36 tests)
...
echo "========================================================"
echo "fully successful test pass writes  22195 bytes to test86"
echo "test pass on AVX2-only CPU writes  17354 bytes to test86"
