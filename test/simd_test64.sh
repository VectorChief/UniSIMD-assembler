...
# with QEMU linux-user mode installed (64-bit Ubuntu 20.04 MATE LTS tested)

touch test64; rm test64

# fully successful test pass results in test64 file of 303630 bytes (51 tests)
# test pass on AVX2-only CPU results in test64 file of 276106 bytes (51 tests)
...
echo "========================================================"
echo "fully successful test pass writes 303630 bytes to test64"
echo "test pass on AVX2-only CPU writes 276106 bytes to test64"
