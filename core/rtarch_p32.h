...
/*
 * rtarch_p32.h: Implementation of PowerPC 32-bit core instructions.
 *
...
#define DG(dp)  ((dp) & 0x7FFC),     0, 0      /* native MIPS core ld/st */
...
#define stack_sa() /* save all [Reax - RegE], TMxx, TIxx, TPxx, 17 regs */  \
        EMITW(0x38000000 | MTM(SPxx,    SPxx,    0x00) | (-0x44 & 0xFFFF))  \
...
#define subxx_ri(RM, IM)                                                    \
        ...
        (+(TP1(IM) == 0) & 0x34000000) | (+(TP1(IM) != 0) & 0x7C000051)   | \
