...
#ifndef RT_RTARCH_X64_512V8_H
#define RT_RTARCH_X64_512V8_H

#include "rtarch_x32_512v8.h"
...
/*
 * rtarch_x64_512v8.h: Implementation of x86_64 fp64 AVX1/2 instruction pairs.
 *
...
#define andqx_rr(XG, XS)                                                    \
        VEX(0,             0, REG(XG), 1, 1, 1) EMITB(0x54)                 \
        MRM(REG(XG), MOD(XS), REG(XS))                                      \
        VEX(1,             1, REH(XG), 1, 1, 1) EMITB(0x54)                 \
        MRM(REG(XG), MOD(XS), REG(XS))

#define andqx_ld(XG, MS, DS)                                                \
    ADR VEX(0,       RXB(MS), REG(XG), 1, 1, 1) EMITB(0x54)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR VEX(1,       RXB(MS), REH(XG), 1, 1, 1) EMITB(0x54)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VXL(DS)), EMPTY)
...
#define annqx_rr(XG, XS)                                                    \
        VEX(0,             0, REG(XG), 1, 1, 1) EMITB(0x55)                 \
        MRM(REG(XG), MOD(XS), REG(XS))                                      \
        VEX(1,             1, REH(XG), 1, 1, 1) EMITB(0x55)                 \
        MRM(REG(XG), MOD(XS), REG(XS))

#define annqx_ld(XG, MS, DS)                                                \
    ADR VEX(0,       RXB(MS), REG(XG), 1, 1, 1) EMITB(0x55)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR VEX(1,       RXB(MS), REH(XG), 1, 1, 1) EMITB(0x55)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VXL(DS)), EMPTY)
...
#define orrqx_rr(XG, XS)                                                    \
        VEX(0,             0, REG(XG), 1, 1, 1) EMITB(0x56)                 \
        MRM(REG(XG), MOD(XS), REG(XS))                                      \
        VEX(1,             1, REH(XG), 1, 1, 1) EMITB(0x56)                 \
        MRM(REG(XG), MOD(XS), REG(XS))

#define orrqx_ld(XG, MS, DS)                                                \
    ADR VEX(0,       RXB(MS), REG(XG), 1, 1, 1) EMITB(0x56)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR VEX(1,       RXB(MS), REH(XG), 1, 1, 1) EMITB(0x56)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VXL(DS)), EMPTY)
...
#define xorqx_rr(XG, XS)                                                    \
        VEX(0,             0, REG(XG), 1, 1, 1) EMITB(0x57)                 \
        MRM(REG(XG), MOD(XS), REG(XS))                                      \
        VEX(1,             1, REH(XG), 1, 1, 1) EMITB(0x57)                 \
        MRM(REG(XG), MOD(XS), REG(XS))

#define xorqx_ld(XG, MS, DS)                                                \
    ADR VEX(0,       RXB(MS), REG(XG), 1, 1, 1) EMITB(0x57)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR VEX(1,       RXB(MS), REH(XG), 1, 1, 1) EMITB(0x57)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VXL(DS)), EMPTY)
...
#define addqs_rr(XG, XS)                                                    \
        VEX(0,             0, REG(XG), 1, 1, 1) EMITB(0x58)                 \
        MRM(REG(XG), MOD(XS), REG(XS))                                      \
        VEX(1,             1, REH(XG), 1, 1, 1) EMITB(0x58)                 \
        MRM(REG(XG), MOD(XS), REG(XS))

#define addqs_ld(XG, MS, DS)                                                \
    ADR VEX(0,       RXB(MS), REG(XG), 1, 1, 1) EMITB(0x58)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR VEX(1,       RXB(MS), REH(XG), 1, 1, 1) EMITB(0x58)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VXL(DS)), EMPTY)
...
#define subqs_rr(XG, XS)                                                    \
        VEX(0,             0, REG(XG), 1, 1, 1) EMITB(0x5C)                 \
        MRM(REG(XG), MOD(XS), REG(XS))                                      \
        VEX(1,             1, REH(XG), 1, 1, 1) EMITB(0x5C)                 \
        MRM(REG(XG), MOD(XS), REG(XS))

#define subqs_ld(XG, MS, DS)                                                \
    ADR VEX(0,       RXB(MS), REG(XG), 1, 1, 1) EMITB(0x5C)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR VEX(1,       RXB(MS), REH(XG), 1, 1, 1) EMITB(0x5C)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VXL(DS)), EMPTY)
...
#define mulqs_rr(XG, XS)                                                    \
        VEX(0,             0, REG(XG), 1, 1, 1) EMITB(0x59)                 \
        MRM(REG(XG), MOD(XS), REG(XS))                                      \
        VEX(1,             1, REH(XG), 1, 1, 1) EMITB(0x59)                 \
        MRM(REG(XG), MOD(XS), REG(XS))

#define mulqs_ld(XG, MS, DS)                                                \
    ADR VEX(0,       RXB(MS), REG(XG), 1, 1, 1) EMITB(0x59)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR VEX(1,       RXB(MS), REH(XG), 1, 1, 1) EMITB(0x59)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VXL(DS)), EMPTY)
...
#define divqs_rr(XG, XS)                                                    \
        VEX(0,             0, REG(XG), 1, 1, 1) EMITB(0x5E)                 \
        MRM(REG(XG), MOD(XS), REG(XS))                                      \
        VEX(1,             1, REH(XG), 1, 1, 1) EMITB(0x5E)                 \
        MRM(REG(XG), MOD(XS), REG(XS))

#define divqs_ld(XG, MS, DS)                                                \
    ADR VEX(0,       RXB(MS), REG(XG), 1, 1, 1) EMITB(0x5E)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR VEX(1,       RXB(MS), REH(XG), 1, 1, 1) EMITB(0x5E)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VXL(DS)), EMPTY)
...
#define shlqx_ri(XG, IS)                                                    \
        VEX(0,             0, REG(XG), 1, 1, 1) EMITB(0x73)                 \
        MRM(0x06,    MOD(XG), REG(XG))                                      \
        AUX(EMPTY,   EMPTY,   EMITB(VAL(IS) & 0x3F))                        \
        VEX(0,             1, REH(XG), 1, 1, 1) EMITB(0x73)                 \
        MRM(0x06,    MOD(XG), REG(XG))                                      \
        AUX(EMPTY,   EMPTY,   EMITB(VAL(IS) & 0x3F))

#define shlqx_ld(XG, MS, DS) /* loads SIMD, uses 64-bit at given address */ \
    ADR VEX(0,       RXB(MS), REG(XG), 1, 1, 1) EMITB(0xF3)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR VEX(1,       RXB(MS), REH(XG), 1, 1, 1) EMITB(0xF3)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)

#define svlqx_rr(XG, XS)     /* variable shift with per-elem count */       \
        VEW(0,             0, REG(XG), 1, 1, 2) EMITB(0x47)                 \
        MRM(REG(XG), MOD(XS), REG(XS))                                      \
        VEW(1,             1, REH(XG), 1, 1, 2) EMITB(0x47)                 \
        MRM(REG(XG), MOD(XS), REG(XS))

#define svlqx_ld(XG, MS, DS) /* variable shift with per-elem count */       \
        VEW(0,       RXB(MS), REG(XG), 1, 1, 2) EMITB(0x47)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
        VEW(1,       RXB(MS), REH(XG), 1, 1, 2) EMITB(0x47)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VXL(DS)), EMPTY)
...
#define shrqx_ld(XG, MS, DS) /* loads SIMD, uses 64-bit at given address */ \
    ADR VEX(0,       RXB(MS), REG(XG), 1, 1, 1) EMITB(0xD3)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR VEX(1,       RXB(MS), REH(XG), 1, 1, 1) EMITB(0xD3)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)

#define svrqx_rr(XG, XS)     /* variable shift with per-elem count */       \
        VEW(0,             0, REG(XG), 1, 1, 2) EMITB(0x45)                 \
        MRM(REG(XG), MOD(XS), REG(XS))                                      \
        VEW(1,             1, REH(XG), 1, 1, 2) EMITB(0x45)                 \
        MRM(REG(XG), MOD(XS), REG(XS))

#define svrqx_ld(XG, MS, DS) /* variable shift with per-elem count */       \
        VEW(0,       RXB(MS), REG(XG), 1, 1, 2) EMITB(0x45)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
        VEW(1,       RXB(MS), REH(XG), 1, 1, 2) EMITB(0x45)                 \
        MRM(REG(XG),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VXL(DS)), EMPTY)
