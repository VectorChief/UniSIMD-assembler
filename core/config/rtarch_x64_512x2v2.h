...
#define mxmqx_ld(PD, XS, MT, DT) /* not portable, do not use outside */     \
    ADR EVW(0,       RXB(MT), REN(XS), K, 1, 2) EMITB(0x29)                 \
        ...
        AUX(SIB(MT), EMITW(VAL(DT)), EMPTY)                                 \
    ADR EVW(0,       RXB(MT), REM(XS), K, 1, 2) EMITB(0x29)                 \
...
#define mmxqx_ld(XD, PS, MT, DT) /* not portable, do not use outside */     \
    ADR EPW(REG(PS),    0x01, RXB(XD), RXB(MT), 0x00, K,1,1) EMITB(0x28)    \
        ...
        AUX(SIB(MT), EMITW(VAL(DT)), EMPTY)                                 \
    ADR EPW(REP(PS),    0x01, RMB(XD), RXB(MT), 0x00, K,1,1) EMITB(0x28)    \
        MRM(REG(XD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VZL(DT)), EMPTY)
...
#define mxmqx_ld(PD, XS, MT, DT) /* not portable, do not use outside */     \
        ...
        EVW(0,       RMB(XS),    0x00, K, 2, 2) EMITB(0x39)                 \
...
#define addqs4rr(XD, PS, XS, XT)                                            \
        ...
        EPW(REP(PS), MOD(PS), RMB(XD), RMB(XT), REM(XS), K,1,1) EMITB(0x58) \
        MRM(REG(XD), MOD(XT), REG(XT))
...
#define addqs4ld(XD, PS, XS, MT, DT)                                        \
    ADR EPW(REG(PS), MOD(PS), RXB(XD), RXB(MT), REN(XS), K,1,1) EMITB(0x58) \
        MRM(REG(XD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VAL(DT)), EMPTY)                                 \
    ADR EPW(REP(PS), MOD(PS), RMB(XD), RXB(MT), REM(XS), K,1,1) EMITB(0x58) \
        MRM(REG(XD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VZL(DT)), EMPTY)
...
#define subqs4rr(XD, PS, XS, XT)                                            \
        ...
        MRM(REG(XD), MOD(XT), REG(XT))                                      \
        EPW(REP(PS), MOD(PS), RMB(XD), RMB(XT), REM(XS), K,1,1) EMITB(0x5C) \
        MRM(REG(XD), MOD(XT), REG(XT))
...
#define subqs4ld(XD, PS, XS, MT, DT)                                        \
    ADR EPW(REG(PS), MOD(PS), RXB(XD), RXB(MT), REN(XS), K,1,1) EMITB(0x5C) \
        MRM(REG(XD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VAL(DT)), EMPTY)                                 \
    ADR EPW(REP(PS), MOD(PS), RMB(XD), RXB(MT), REM(XS), K,1,1) EMITB(0x5C) \
        MRM(REG(XD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VZL(DT)), EMPTY)
...
#define mulqs4rr(XD, PS, XS, XT)                                            \
        ...
        MRM(REG(XD), MOD(XT), REG(XT))                                      \
        EPW(REP(PS), MOD(PS), RMB(XD), RMB(XT), REM(XS), K,1,1) EMITB(0x59) \
        MRM(REG(XD), MOD(XT), REG(XT))
...
#define mulqs4ld(XD, PS, XS, MT, DT)                                        \
    ADR EPW(REG(PS), MOD(PS), RXB(XD), RXB(MT), REN(XS), K,1,1) EMITB(0x59) \
        MRM(REG(XD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VAL(DT)), EMPTY)                                 \
    ADR EPW(REP(PS), MOD(PS), RMB(XD), RXB(MT), REM(XS), K,1,1) EMITB(0x59) \
        MRM(REG(XD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VZL(DT)), EMPTY)
...
#define divqs4rr(XD, PS, XS, XT)                                            \
        ...
        MRM(REG(XD), MOD(XT), REG(XT))                                      \
        EPW(REP(PS), MOD(PS), RMB(XD), RMB(XT), REM(XS), K,1,1) EMITB(0x5E) \
        MRM(REG(XD), MOD(XT), REG(XT))
...
#define divqs4ld(XD, PS, XS, MT, DT)                                        \
    ADR EPW(REG(PS), MOD(PS), RXB(XD), RXB(MT), REN(XS), K,1,1) EMITB(0x5E) \
        MRM(REG(XD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VAL(DT)), EMPTY)                                 \
    ADR EPW(REP(PS), MOD(PS), RMB(XD), RXB(MT), REM(XS), K,1,1) EMITB(0x5E) \
        MRM(REG(XD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VZL(DT)), EMPTY)
...
#define sqrqsMrr(XD, PS, XS)     /* merging-masking only */                 \
        EPW(REG(PS), 0,       RXB(XD), RXB(XS),    0x00, K,1,1) EMITB(0x51) \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EPW(REP(PS), 0,       RMB(XD), RMB(XS),    0x00, K,1,1) EMITB(0x51) \
        MRM(REG(XD), MOD(XS), REG(XS))

#define sqrqsMld(XD, PS, MS, DS) /* merging-masking only */                 \
    ADR EPW(REG(PS), 0,       RXB(XD), RXB(MS),    0x00, K,1,1) EMITB(0x51) \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR EPW(REP(PS), 0,       RMB(XD), RXB(MS),    0x00, K,1,1) EMITB(0x51) \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VZL(DS)), EMPTY)

#define sqrqsPrr(XD, PS, XS)                                                \
        EPW(REG(PS), MOD(PS), RXB(XD), RXB(XS),    0x00, K,1,1) EMITB(0x51) \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EPW(REP(PS), MOD(PS), RMB(XD), RMB(XS),    0x00, K,1,1) EMITB(0x51) \
        MRM(REG(XD), MOD(XS), REG(XS))

#define sqrqsPld(XD, PS, MS, DS)                                            \
    ADR EPW(REG(PS), MOD(PS), RXB(XD), RXB(MS),    0x00, K,1,1) EMITB(0x51) \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR EPW(REP(PS), MOD(PS), RMB(XD), RXB(MS),    0x00, K,1,1) EMITB(0x51) \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VZL(DS)), EMPTY)
...
#define ceqqs4rr(PD, PS, XS, XT)     /* zeroing-masking only */             \
        ...
        MRM(REG(PD), MOD(XT), REG(XT))                                      \
        AUX(EMPTY,   EMPTY,   EMITB(0x00))                                  \
        EPW(REP(PS), 1,       0,       RMB(XT), REM(XS), K,1,1) EMITB(0xC2) \
        MRM(REP(PD), MOD(XT), REG(XT))                                      \
        AUX(EMPTY,   EMPTY,   EMITB(0x00))
...
#define ceqqs4ld(PD, PS, XS, MT, DT) /* zeroing-masking only */             \
    ADR EPW(REG(PS), 1,       0,       RXB(MT), REN(XS), K,1,1) EMITB(0xC2) \
        MRM(REG(PD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VAL(DT)), EMITB(0x00))                           \
    ADR EPW(REP(PS), 1,       0,       RXB(MT), REM(XS), K,1,1) EMITB(0xC2) \
        MRM(REP(PD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VZL(DT)), EMITB(0x00))
...
#define ceqqxPrr(PD, XS, XT)                                                \
        ...
        MRM(REG(PD), MOD(XT), REG(XT))                                      \
        AUX(EMPTY,   EMPTY,   EMITB(0x00))                                  \
        EVW(0,       RMB(XT), REM(XS), K, 1, 3) EMITB(0x1E)                 \
        MRM(REP(PD), MOD(XT), REG(XT))                                      \
        AUX(EMPTY,   EMPTY,   EMITB(0x00))
...
#define ceqqxPld(PD, XS, MT, DT)                                            \
    ADR EVW(0,       RXB(MT), REN(XS), K, 1, 3) EMITB(0x1E)                 \
        MRM(REG(PD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VAL(DT)), EMITB(0x00))                           \
    ADR EVW(0,       RXB(MT), REM(XS), K, 1, 3) EMITB(0x1E)                 \
        MRM(REP(PD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VZL(DT)), EMITB(0x00))

#define ceqqx4rr(PD, PS, XS, XT)     /* zeroing-masking only */             \
        EPW(REG(PS), 1,       0,       RXB(XT), REN(XS), K,1,3) EMITB(0x1E) \
        MRM(REG(PD), MOD(XT), REG(XT))                                      \
        AUX(EMPTY,   EMPTY,   EMITB(0x00))                                  \
        EPW(REP(PS), 1,       0,       RMB(XT), REM(XS), K,1,3) EMITB(0x1E) \
        MRM(REP(PD), MOD(XT), REG(XT))                                      \
        AUX(EMPTY,   EMPTY,   EMITB(0x00))

#define ceqqx4ld(PD, PS, XS, MT, DT) /* zeroing-masking only */             \
    ADR EPW(REG(PS), 1,       0,       RXB(MT), REN(XS), K,1,3) EMITB(0x1E) \
        MRM(REG(PD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VAL(DT)), EMITB(0x00))                           \
    ADR EPW(REP(PS), 1,       0,       RXB(MT), REM(XS), K,1,3) EMITB(0x1E) \
        MRM(REP(PD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VZL(DT)), EMITB(0x00))
...
#define cltqnPrr(PD, XS, XT)                                                \
        ...
        MRM(REG(PD), MOD(XT), REG(XT))                                      \
        AUX(EMPTY,   EMPTY,   EMITB(0x01))                                  \
        EVW(0,       RMB(XT), REM(XS), K, 1, 3) EMITB(0x1F)                 \
        MRM(REP(PD), MOD(XT), REG(XT))                                      \
        AUX(EMPTY,   EMPTY,   EMITB(0x01))
...
#define cltqnPld(PD, XS, MT, DT)                                            \
    ADR EVW(0,       RXB(MT), REN(XS), K, 1, 3) EMITB(0x1F)                 \
        MRM(REG(PD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VAL(DT)), EMITB(0x01))                           \
    ADR EVW(0,       RXB(MT), REM(XS), K, 1, 3) EMITB(0x1F)                 \
        MRM(REP(PD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VZL(DT)), EMITB(0x01))

#define cltqn4rr(PD, PS, XS, XT)     /* zeroing-masking only */             \
        EPW(REG(PS), 1,       0,       RXB(XT), REN(XS), K,1,3) EMITB(0x1F) \
        MRM(REG(PD), MOD(XT), REG(XT))                                      \
        AUX(EMPTY,   EMPTY,   EMITB(0x01))                                  \
        EPW(REP(PS), 1,       0,       RMB(XT), REM(XS), K,1,3) EMITB(0x1F) \
        MRM(REP(PD), MOD(XT), REG(XT))                                      \
        AUX(EMPTY,   EMPTY,   EMITB(0x01))

#define cltqn4ld(PD, PS, XS, MT, DT) /* zeroing-masking only */             \
    ADR EPW(REG(PS), 1,       0,       RXB(MT), REN(XS), K,1,3) EMITB(0x1F) \
        MRM(REG(PD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VAL(DT)), EMITB(0x01))                           \
    ADR EPW(REP(PS), 1,       0,       RXB(MT), REM(XS), K,1,3) EMITB(0x1F) \
        MRM(REP(PD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VZL(DT)), EMITB(0x01))
...
#define fmaqs_rr(XG, XS, XT)                                                \
        ...
        EVW(RMB(XG), RMB(XT), REM(XS), K, 1, 2) EMITB(0xB8)                 \
        MRM(REG(XG), MOD(XT), REG(XT))
...
#define fmsqs_rr(XG, XS, XT)                                                \
        ...
        MRM(REG(XG), MOD(XT), REG(XT))                                      \
        EVW(RMB(XG), RMB(XT), REM(XS), K, 1, 2) EMITB(0xBC)                 \
        MRM(REG(XG), MOD(XT), REG(XT))
...
#define cvnqx_rr(XD, XS)     /* round towards near */                       \
        ...
        fpuzs_st(Mebp,  inf_SCR01(0x38))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0x40))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0x44), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0x40))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0x48))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0x4C), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0x48))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0x50))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0x54), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0x50))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0x58))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0x5C), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0x58))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0x60))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0x64), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0x60))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0x68))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0x6C), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0x68))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0x70))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0x74), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0x70))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0x78))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0x7C), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0x78))                                    \
        movqx_ld(W(XD), Mebp, inf_SCR01(0))
...
#define cvnqx_rr(XD, XS)     /* round towards near */                       \
        ...
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EVW(RMB(XD), RMB(XS),    0x00, K, 2, 1) EMITB(0x7A)                 \
        MRM(REG(XD), MOD(XS), REG(XS))
...
#define cvnqx_ld(XD, MS, DS) /* round towards near */                       \
    ADR EVW(RXB(XD), RXB(MS),    0x00, K, 2, 1) EMITB(0x7A)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR EVW(RMB(XD), RXB(MS),    0x00, K, 2, 1) EMITB(0x7A)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VZL(DS)), EMPTY)
...
#define cuzqs_rr(XD, XS)     /* round towards zero */                       \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0x40))                                    \
        addwx_mi(Mebp,  inf_SCR01(0x44), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0x48))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0x48))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0x48))                                    \
        addwx_mi(Mebp,  inf_SCR01(0x4C), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0x50))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0x50))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0x50))                                    \
        addwx_mi(Mebp,  inf_SCR01(0x54), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0x58))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0x58))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0x58))                                    \
        addwx_mi(Mebp,  inf_SCR01(0x5C), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0x60))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0x60))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0x60))                                    \
        addwx_mi(Mebp,  inf_SCR01(0x64), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0x68))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0x68))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0x68))                                    \
        addwx_mi(Mebp,  inf_SCR01(0x6C), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0x70))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0x70))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0x70))                                    \
        addwx_mi(Mebp,  inf_SCR01(0x74), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0x78))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0x78))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0x78))                                    \
        addwx_mi(Mebp,  inf_SCR01(0x7C), IW(0x80000000))                    \
...
#define cuzqs_rr(XD, XS)     /* round towards zero */                       \
        ...
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EVW(RMB(XD), RMB(XS),    0x00, K, 1, 1) EMITB(0x78)                 \
        MRM(REG(XD), MOD(XS), REG(XS))
...
#define cuzqs_ld(XD, MS, DS) /* round towards zero */                       \
    ADR EVW(RXB(XD), RXB(MS),    0x00, K, 1, 1) EMITB(0x78)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR EVW(RMB(XD), RXB(MS),    0x00, K, 1, 1) EMITB(0x78)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VZL(DS)), EMPTY)
...
#define cupqs_rr(XD, XS)     /* round towards +inf */                       \
        ...
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERW(RMB(XD), RMB(XS),    0x00, 2, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))
...
#define cumqs_rr(XD, XS)     /* round towards -inf */                       \
        ...
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERW(RMB(XD), RMB(XS),    0x00, 1, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))
...
#define cunqs_rr(XD, XS)     /* round towards near */                       \
        ...
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EVW(RMB(XD), RMB(XS),    0x00, K, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))
...
#define cunqs_ld(XD, MS, DS) /* round towards near */                       \
    ADR EVW(RXB(XD), RXB(MS),    0x00, K, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR EVW(RMB(XD), RXB(MS),    0x00, K, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VZL(DS)), EMPTY)
...
#define minqx3rr(XD, XS, XT)                                                \
        ...
        MRM(REG(XD), MOD(XT), REG(XT))                                      \
        EVW(RMB(XD), RMB(XT), REM(XS), K, 1, 2) EMITB(0x3B)                 \
        MRM(REG(XD), MOD(XT), REG(XT))
...
#define minqx3ld(XD, XS, MT, DT)                                            \
    ADR EVW(RXB(XD), RXB(MT), REN(XS), K, 1, 2) EMITB(0x3B)                 \
        MRM(REG(XD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VAL(DT)), EMPTY)                                 \
    ADR EVW(RMB(XD), RXB(MT), REM(XS), K, 1, 2) EMITB(0x3B)                 \
        MRM(REG(XD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VZL(DT)), EMPTY)
...
#define minqn3rr(XD, XS, XT)                                                \
        ...
        MRM(REG(XD), MOD(XT), REG(XT))                                      \
        EVW(RMB(XD), RMB(XT), REM(XS), K, 1, 2) EMITB(0x39)                 \
        MRM(REG(XD), MOD(XT), REG(XT))
...
#define minqn3ld(XD, XS, MT, DT)                                            \
    ADR EVW(RXB(XD), RXB(MT), REN(XS), K, 1, 2) EMITB(0x39)                 \
        MRM(REG(XD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VAL(DT)), EMPTY)                                 \
    ADR EVW(RMB(XD), RXB(MT), REM(XS), K, 1, 2) EMITB(0x39)                 \
        MRM(REG(XD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VZL(DT)), EMPTY)
...
#define maxqx3rr(XD, XS, XT)                                                \
        ...
        MRM(REG(XD), MOD(XT), REG(XT))                                      \
        EVW(RMB(XD), RMB(XT), REM(XS), K, 1, 2) EMITB(0x3F)                 \
        MRM(REG(XD), MOD(XT), REG(XT))
...
#define maxqx3ld(XD, XS, MT, DT)                                            \
    ADR EVW(RXB(XD), RXB(MT), REN(XS), K, 1, 2) EMITB(0x3F)                 \
        MRM(REG(XD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VAL(DT)), EMPTY)                                 \
    ADR EVW(RMB(XD), RXB(MT), REM(XS), K, 1, 2) EMITB(0x3F)                 \
        MRM(REG(XD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VZL(DT)), EMPTY)
...
#define maxqn3rr(XD, XS, XT)                                                \
        ...
        MRM(REG(XD), MOD(XT), REG(XT))                                      \
        EVW(RMB(XD), RMB(XT), REM(XS), K, 1, 2) EMITB(0x3D)                 \
        MRM(REG(XD), MOD(XT), REG(XT))
...
#define maxqn3ld(XD, XS, MT, DT)                                            \
    ADR EVW(RXB(XD), RXB(MT), REN(XS), K, 1, 2) EMITB(0x3D)                 \
        MRM(REG(XD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VAL(DT)), EMPTY)                                 \
    ADR EVW(RMB(XD), RXB(MT), REM(XS), K, 1, 2) EMITB(0x3D)                 \
        MRM(REG(XD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VZL(DT)), EMPTY)
