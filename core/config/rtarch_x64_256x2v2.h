...
#define mmvqx_rr(XG, XS)                                                    \
        VEX(0,             0, REG(XG), 1, 1, 3) EMITB(0x4B)                 \
        MRM(REG(XG), MOD(XS), REG(XS))                                      \
        AUX(EMPTY,   EMPTY,   EMITB(0x00))                                  \
        VEX(1,             1, REH(XG), 1, 1, 3) EMITB(0x4B)                 \
        MRM(REG(XG), MOD(XS), REG(XS))                                      \
...
#define fmaqs_rr(XG, XS, XT)                                                \
        VEW(0,             0, REG(XS), 1, 1, 2) EMITB(0xB8)                 \
        MRM(REG(XG), MOD(XT), REG(XT))                                      \
        VEW(1,             1, REH(XS), 1, 1, 2) EMITB(0xB8)                 \
        MRM(REG(XG), MOD(XT), REG(XT))
...
#define fmsqs_rr(XG, XS, XT)                                                \
        VEW(0,             0, REG(XS), 1, 1, 2) EMITB(0xBC)                 \
        MRM(REG(XG), MOD(XT), REG(XT))                                      \
        VEW(1,             1, REH(XS), 1, 1, 2) EMITB(0xBC)                 \
        MRM(REG(XG), MOD(XT), REG(XT))
...
#define RT_SIMD_MASK_FULL64_512    0x0F     /*  all satisfy the condition */

#define mkjqx_rx(XS, mask, lb)   /* destroys Reax, if S == mask jump lb */  \
        VEX(0,             0,    0x00, 1, 1, 1) EMITB(0x50)                 \
        MRM(0x00,    MOD(XS), REG(XS))                                      \
        VEX(1,             1,    0x00, 1, 1, 1) EMITB(0x50)                 \
        MRM(0x07,    MOD(XS), REG(XS))                                      \
        REX(0,             1)                                               \
        EMITB(0x03 | (0x08 << ((RT_SIMD_MASK_##mask##64_512 & 0x1) << 1)))  \
        MRM(0x00,       0x03, 0x07)                                         \
        cmpwx_ri(Reax, IB(RT_SIMD_MASK_##mask##64_512))                     \
        jeqxx_lb(lb)
...
#define minqx_rx(XD) /* not portable, do not use outside */                 \
        stack_st(Reax)                                                      \
        ...
        cmpzx_rm(Reax,  Mebp, inf_SCR02(0x20))                              \
        EMITB(0x73) EMITB(0x07 + x67)                                       \
        movzx_st(Reax,  Mebp, inf_SCR02(0x20))                              \
        movzx_ld(Reax,  Mebp, inf_SCR01(0x28))                              \
        cmpzx_rm(Reax,  Mebp, inf_SCR02(0x28))                              \
        EMITB(0x73) EMITB(0x07 + x67)                                       \
        movzx_st(Reax,  Mebp, inf_SCR02(0x28))                              \
        movzx_ld(Reax,  Mebp, inf_SCR01(0x30))                              \
        cmpzx_rm(Reax,  Mebp, inf_SCR02(0x30))                              \
        EMITB(0x73) EMITB(0x07 + x67)                                       \
        movzx_st(Reax,  Mebp, inf_SCR02(0x30))                              \
        movzx_ld(Reax,  Mebp, inf_SCR01(0x38))                              \
        cmpzx_rm(Reax,  Mebp, inf_SCR02(0x38))                              \
        EMITB(0x73) EMITB(0x07 + x67)                                       \
        movzx_st(Reax,  Mebp, inf_SCR02(0x38))                              \
        stack_ld(Reax)                                                      \
...
#define minqn_rx(XD) /* not portable, do not use outside */                 \
        stack_st(Reax)                                                      \
        movzx_ld(Reax,  Mebp, inf_SCR01(0x00))                              \
        cmpzx_rm(Reax,  Mebp, inf_SCR02(0x00))                              \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
...
#define maxqx_rx(XD) /* not portable, do not use outside */                 \
        stack_st(Reax)                                                      \
        movzx_ld(Reax,  Mebp, inf_SCR01(0x00))                              \
        cmpzx_rm(Reax,  Mebp, inf_SCR02(0x00))                              \
...
#define maxqn_rx(XD) /* not portable, do not use outside */                 \
        stack_st(Reax)                                                      \
        movzx_ld(Reax,  Mebp, inf_SCR01(0x00))                              \
        cmpzx_rm(Reax,  Mebp, inf_SCR02(0x00))                              \
...
#define ceqqx3rr(XD, XS, XT)                                                \
        VEX(0,             0, REG(XS), 1, 1, 2) EMITB(0x29)                 \
        MRM(REG(XD), MOD(XT), REG(XT))                                      \
        VEX(1,             1, REH(XS), 1, 1, 2) EMITB(0x29)                 \
        MRM(REG(XD), MOD(XT), REG(XT))

#define ceqqx3ld(XD, XS, MT, DT)                                            \
    ADR VEX(0,       RXB(MT), REG(XS), 1, 1, 2) EMITB(0x29)                 \
        MRM(REG(XD),    0x02, REG(MT))                                      \
        AUX(SIB(MT), EMITW(VAL(DT)), EMPTY)                                 \
