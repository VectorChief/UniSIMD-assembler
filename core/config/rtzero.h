...
#undef Iebx /* external name for BASE+Reax*1+displ addressing */
#undef Iecx /* external name for BASE+Reax*1+displ addressing */
#undef Iedx /* external name for BASE+Reax*1+displ addressing */
#undef Iebp /* external name for BASE+Reax*1+displ addressing */
#undef Iesi /* external name for BASE+Reax*1+displ addressing */
#undef Iedi /* external name for BASE+Reax*1+displ addressing */
#undef Ieg8 /* external name for BASE+Reax*1+displ addressing */
#undef Ieg9 /* external name for BASE+Reax*1+displ addressing */
#undef IegA /* external name for BASE+Reax*1+displ addressing */
#undef IegB /* external name for BASE+Reax*1+displ addressing */
#undef IegC /* external name for BASE+Reax*1+displ addressing */
#undef IegD /* external name for BASE+Reax*1+displ addressing */
#undef IegE /* external name for BASE+Reax*1+displ addressing */

#undef Jebx /* external name for BASE+Reax*2+displ addressing */
#undef Jecx /* external name for BASE+Reax*2+displ addressing */
#undef Jedx /* external name for BASE+Reax*2+displ addressing */
#undef Jebp /* external name for BASE+Reax*2+displ addressing */
#undef Jesi /* external name for BASE+Reax*2+displ addressing */
#undef Jedi /* external name for BASE+Reax*2+displ addressing */
#undef Jeg8 /* external name for BASE+Reax*2+displ addressing */
#undef Jeg9 /* external name for BASE+Reax*2+displ addressing */
#undef JegA /* external name for BASE+Reax*2+displ addressing */
#undef JegB /* external name for BASE+Reax*2+displ addressing */
#undef JegC /* external name for BASE+Reax*2+displ addressing */
#undef JegD /* external name for BASE+Reax*2+displ addressing */
#undef JegE /* external name for BASE+Reax*2+displ addressing */

#undef Kebx /* external name for BASE+Reax*4+displ addressing */
#undef Kecx /* external name for BASE+Reax*4+displ addressing */
#undef Kedx /* external name for BASE+Reax*4+displ addressing */
#undef Kebp /* external name for BASE+Reax*4+displ addressing */
#undef Kesi /* external name for BASE+Reax*4+displ addressing */
#undef Kedi /* external name for BASE+Reax*4+displ addressing */
#undef Keg8 /* external name for BASE+Reax*4+displ addressing */
#undef Keg9 /* external name for BASE+Reax*4+displ addressing */
#undef KegA /* external name for BASE+Reax*4+displ addressing */
#undef KegB /* external name for BASE+Reax*4+displ addressing */
#undef KegC /* external name for BASE+Reax*4+displ addressing */
#undef KegD /* external name for BASE+Reax*4+displ addressing */
#undef KegE /* external name for BASE+Reax*4+displ addressing */

#undef Lebx /* external name for BASE+Reax*8+displ addressing */
#undef Lecx /* external name for BASE+Reax*8+displ addressing */
#undef Ledx /* external name for BASE+Reax*8+displ addressing */
#undef Lebp /* external name for BASE+Reax*8+displ addressing */
#undef Lesi /* external name for BASE+Reax*8+displ addressing */
#undef Ledi /* external name for BASE+Reax*8+displ addressing */
#undef Leg8 /* external name for BASE+Reax*8+displ addressing */
#undef Leg9 /* external name for BASE+Reax*8+displ addressing */
#undef LegA /* external name for BASE+Reax*8+displ addressing */
#undef LegB /* external name for BASE+Reax*8+displ addressing */
#undef LegC /* external name for BASE+Reax*8+displ addressing */
#undef LegD /* external name for BASE+Reax*8+displ addressing */
#undef LegE /* external name for BASE+Reax*8+displ addressing */

#undef Sebx /* external name for BASE+index*1+displ addressing */
#undef Secx /* external name for BASE+index*1+displ addressing */
#undef Sedx /* external name for BASE+index*1+displ addressing */
#undef Sebp /* external name for BASE+index*1+displ addressing */
#undef Sesi /* external name for BASE+index*1+displ addressing */
#undef Sedi /* external name for BASE+index*1+displ addressing */
#undef Seg8 /* external name for BASE+index*1+displ addressing */
#undef Seg9 /* external name for BASE+index*1+displ addressing */
#undef SegA /* external name for BASE+index*1+displ addressing */
#undef SegB /* external name for BASE+index*1+displ addressing */
#undef SegC /* external name for BASE+index*1+displ addressing */
#undef SegD /* external name for BASE+index*1+displ addressing */
#undef SegE /* external name for BASE+index*1+displ addressing */

#undef Tebx /* external name for BASE+index*2+displ addressing */
#undef Tecx /* external name for BASE+index*2+displ addressing */
#undef Tedx /* external name for BASE+index*2+displ addressing */
#undef Tebp /* external name for BASE+index*2+displ addressing */
#undef Tesi /* external name for BASE+index*2+displ addressing */
#undef Tedi /* external name for BASE+index*2+displ addressing */
#undef Teg8 /* external name for BASE+index*2+displ addressing */
#undef Teg9 /* external name for BASE+index*2+displ addressing */
#undef TegA /* external name for BASE+index*2+displ addressing */
#undef TegB /* external name for BASE+index*2+displ addressing */
#undef TegC /* external name for BASE+index*2+displ addressing */
#undef TegD /* external name for BASE+index*2+displ addressing */
#undef TegE /* external name for BASE+index*2+displ addressing */

#undef Uebx /* external name for BASE+index*4+displ addressing */
#undef Uecx /* external name for BASE+index*4+displ addressing */
#undef Uedx /* external name for BASE+index*4+displ addressing */
#undef Uebp /* external name for BASE+index*4+displ addressing */
#undef Uesi /* external name for BASE+index*4+displ addressing */
#undef Uedi /* external name for BASE+index*4+displ addressing */
#undef Ueg8 /* external name for BASE+index*4+displ addressing */
#undef Ueg9 /* external name for BASE+index*4+displ addressing */
#undef UegA /* external name for BASE+index*4+displ addressing */
#undef UegB /* external name for BASE+index*4+displ addressing */
#undef UegC /* external name for BASE+index*4+displ addressing */
#undef UegD /* external name for BASE+index*4+displ addressing */
#undef UegE /* external name for BASE+index*4+displ addressing */

#undef Vebx /* external name for BASE+index*8+displ addressing */
#undef Vecx /* external name for BASE+index*8+displ addressing */
#undef Vedx /* external name for BASE+index*8+displ addressing */
#undef Vebp /* external name for BASE+index*8+displ addressing */
#undef Vesi /* external name for BASE+index*8+displ addressing */
#undef Vedi /* external name for BASE+index*8+displ addressing */
#undef Veg8 /* external name for BASE+index*8+displ addressing */
#undef Veg9 /* external name for BASE+index*8+displ addressing */
#undef VegA /* external name for BASE+index*8+displ addressing */
#undef VegB /* external name for BASE+index*8+displ addressing */
#undef VegC /* external name for BASE+index*8+displ addressing */
#undef VegD /* external name for BASE+index*8+displ addressing */
#undef VegE /* external name for BASE+index*8+displ addressing */

#undef Nebx /* external name for BASE+index*scale+displ addressing */
#undef Necx /* external name for BASE+index*scale+displ addressing */
#undef Nedx /* external name for BASE+index*scale+displ addressing */
#undef Nebp /* external name for BASE+index*scale+displ addressing */
#undef Nesi /* external name for BASE+index*scale+displ addressing */
#undef Nedi /* external name for BASE+index*scale+displ addressing */
#undef Neg8 /* external name for BASE+index*scale+displ addressing */
#undef Neg9 /* external name for BASE+index*scale+displ addressing */
#undef NegA /* external name for BASE+index*scale+displ addressing */
#undef NegB /* external name for BASE+index*scale+displ addressing */
#undef NegC /* external name for BASE+index*scale+displ addressing */
#undef NegD /* external name for BASE+index*scale+displ addressing */
#undef NegE /* external name for BASE+index*scale+displ addressing */
...
#endif
#if   !(defined RT_AWEX2) && (RT_1K4 || RT_1K4_R8)
#define         RT_512X2     (RT_1K4 |  RT_1K4_R8)
#define         RT_AWEX2     (RT_1K4 |  RT_1K4_R8)
#endif
