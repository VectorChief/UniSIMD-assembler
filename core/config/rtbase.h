...
/*
 * Map existing scalable addressing modes to a fully customizable ones.
 */
#define Iecx    Secx(Reax)
#define Iedx    Sedx(Reax)
#define Iebx    Sebx(Reax)
#define Iebp    Sebp(Reax)
#define Iesi    Sesi(Reax)
#define Iedi    Sedi(Reax)
#define Ieg8    Seg8(Reax)
#define Ieg9    Seg9(Reax)
#define IegA    SegA(Reax)
#define IegB    SegB(Reax)
#define IegC    SegC(Reax)
#define IegD    SegD(Reax)
#define IegE    SegE(Reax)

#define Jecx    Tecx(Reax)
#define Jedx    Tedx(Reax)
#define Jebx    Tebx(Reax)
#define Jebp    Tebp(Reax)
#define Jesi    Tesi(Reax)
#define Jedi    Tedi(Reax)
#define Jeg8    Teg8(Reax)
#define Jeg9    Teg9(Reax)
#define JegA    TegA(Reax)
#define JegB    TegB(Reax)
#define JegC    TegC(Reax)
#define JegD    TegD(Reax)
#define JegE    TegE(Reax)

#define Kecx    Uecx(Reax)
#define Kedx    Uedx(Reax)
#define Kebx    Uebx(Reax)
#define Kebp    Uebp(Reax)
#define Kesi    Uesi(Reax)
#define Kedi    Uedi(Reax)
#define Keg8    Ueg8(Reax)
#define Keg9    Ueg9(Reax)
#define KegA    UegA(Reax)
#define KegB    UegB(Reax)
#define KegC    UegC(Reax)
#define KegD    UegD(Reax)
#define KegE    UegE(Reax)

#define Lecx    Vecx(Reax)
#define Ledx    Vedx(Reax)
#define Lebx    Vebx(Reax)
#define Lebp    Vebp(Reax)
#define Lesi    Vesi(Reax)
#define Ledi    Vedi(Reax)
#define Leg8    Veg8(Reax)
#define Leg9    Veg9(Reax)
#define LegA    VegA(Reax)
#define LegB    VegB(Reax)
#define LegC    VegC(Reax)
#define LegD    VegD(Reax)
#define LegE    VegE(Reax)

#define Tecx(R) Necx(W(R),1)
#define Tedx(R) Nedx(W(R),1)
#define Tebx(R) Nebx(W(R),1)
#define Tebp(R) Nebp(W(R),1)
#define Tesi(R) Nesi(W(R),1)
#define Tedi(R) Nedi(W(R),1)
#define Teg8(R) Neg8(W(R),1)
#define Teg9(R) Neg9(W(R),1)
#define TegA(R) NegA(W(R),1)
#define TegB(R) NegB(W(R),1)
#define TegC(R) NegC(W(R),1)
#define TegD(R) NegD(W(R),1)
#define TegE(R) NegE(W(R),1)

#define Uecx(R) Necx(W(R),2)
#define Uedx(R) Nedx(W(R),2)
#define Uebx(R) Nebx(W(R),2)
#define Uebp(R) Nebp(W(R),2)
#define Uesi(R) Nesi(W(R),2)
#define Uedi(R) Nedi(W(R),2)
#define Ueg8(R) Neg8(W(R),2)
#define Ueg9(R) Neg9(W(R),2)
#define UegA(R) NegA(W(R),2)
#define UegB(R) NegB(W(R),2)
#define UegC(R) NegC(W(R),2)
#define UegD(R) NegD(W(R),2)
#define UegE(R) NegE(W(R),2)

#define Vecx(R) Necx(W(R),3)
#define Vedx(R) Nedx(W(R),3)
#define Vebx(R) Nebx(W(R),3)
#define Vebp(R) Nebp(W(R),3)
#define Vesi(R) Nesi(W(R),3)
#define Vedi(R) Nedi(W(R),3)
#define Veg8(R) Neg8(W(R),3)
#define Veg9(R) Neg9(W(R),3)
#define VegA(R) NegA(W(R),3)
#define VegB(R) NegB(W(R),3)
#define VegC(R) NegC(W(R),3)
#define VegD(R) NegD(W(R),3)
#define VegE(R) NegE(W(R),3)
