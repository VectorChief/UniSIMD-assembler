...
#if (RT_512X1 == 1 || RT_512X1 == 4) /* instructions below require AVX512BW */
...
#define mkjmb_rx(XS, mask, lb)   /* destroys Reax, if S == mask jump lb */  \
        ...
        bsncx_rx(Xmm0,  mask)                                               \
        movab_ld(Xmm0,  Mebp, inf_SCR01(0x00))                              \
        shlcx_ri(Xmm0,  IB(8))                                              \
        bsncx_rx(Xmm0,  mask)                                               \
        movab_ld(Xmm0,  Mebp, inf_SCR01(0x20))                              \
        shlcx_ri(Xmm0,  IB(8))                                              \
...
#define mkjmb_rx(XS, mask, lb)   /* destroys Reax, if S == mask jump lb */  \
        ...
        mk1bx_rx(Reax)                                                      \
        movzx_mj(Mebp, inf_SCR02(0), IW(RT_SIMD_MASK_##mask##08_512),       \
                                     IW(RT_SIMD_MASK_##mask##08_512))       \
