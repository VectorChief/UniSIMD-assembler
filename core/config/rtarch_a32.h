...
#define Secx(R) TEcx, TPxx, EMITW(0x0B000000 | MRM(TPxx, TEcx, REG(R)) | ADR)
#define Sedx(R) TEdx, TPxx, EMITW(0x0B000000 | MRM(TPxx, TEdx, REG(R)) | ADR)
#define Sebx(R) TEbx, TPxx, EMITW(0x0B000000 | MRM(TPxx, TEbx, REG(R)) | ADR)
#define Sebp(R) TEbp, TPxx, EMITW(0x0B000000 | MRM(TPxx, TEbp, REG(R)) | ADR)
#define Sesi(R) TEsi, TPxx, EMITW(0x0B000000 | MRM(TPxx, TEsi, REG(R)) | ADR)
#define Sedi(R) TEdi, TPxx, EMITW(0x0B000000 | MRM(TPxx, TEdi, REG(R)) | ADR)
#define Seg8(R) TEg8, TPxx, EMITW(0x0B000000 | MRM(TPxx, TEg8, REG(R)) | ADR)
#define Seg9(R) TEg9, TPxx, EMITW(0x0B000000 | MRM(TPxx, TEg9, REG(R)) | ADR)
#define SegA(R) TEgA, TPxx, EMITW(0x0B000000 | MRM(TPxx, TEgA, REG(R)) | ADR)
#define SegB(R) TEgB, TPxx, EMITW(0x0B000000 | MRM(TPxx, TEgB, REG(R)) | ADR)
#define SegC(R) TEgC, TPxx, EMITW(0x0B000000 | MRM(TPxx, TEgC, REG(R)) | ADR)
#define SegD(R) TEgD, TPxx, EMITW(0x0B000000 | MRM(TPxx, TEgD, REG(R)) | ADR)
#define SegE(R) TEgE, TPxx, EMITW(0x0B000000 | MRM(TPxx, TEgE, REG(R)) | ADR)

#define Necx(R,n) TEcx,TPxx,EMITW(0x0B000000|MRM(TPxx,TEcx,REG(R))|ADR|(n)<<10)
#define Nedx(R,n) TEdx,TPxx,EMITW(0x0B000000|MRM(TPxx,TEdx,REG(R))|ADR|(n)<<10)
#define Nebx(R,n) TEbx,TPxx,EMITW(0x0B000000|MRM(TPxx,TEbx,REG(R))|ADR|(n)<<10)
#define Nebp(R,n) TEbp,TPxx,EMITW(0x0B000000|MRM(TPxx,TEbp,REG(R))|ADR|(n)<<10)
#define Nesi(R,n) TEsi,TPxx,EMITW(0x0B000000|MRM(TPxx,TEsi,REG(R))|ADR|(n)<<10)
#define Nedi(R,n) TEdi,TPxx,EMITW(0x0B000000|MRM(TPxx,TEdi,REG(R))|ADR|(n)<<10)
#define Neg8(R,n) TEg8,TPxx,EMITW(0x0B000000|MRM(TPxx,TEg8,REG(R))|ADR|(n)<<10)
#define Neg9(R,n) TEg9,TPxx,EMITW(0x0B000000|MRM(TPxx,TEg9,REG(R))|ADR|(n)<<10)
#define NegA(R,n) TEgA,TPxx,EMITW(0x0B000000|MRM(TPxx,TEgA,REG(R))|ADR|(n)<<10)
#define NegB(R,n) TEgB,TPxx,EMITW(0x0B000000|MRM(TPxx,TEgB,REG(R))|ADR|(n)<<10)
#define NegC(R,n) TEgC,TPxx,EMITW(0x0B000000|MRM(TPxx,TEgC,REG(R))|ADR|(n)<<10)
#define NegD(R,n) TEgD,TPxx,EMITW(0x0B000000|MRM(TPxx,TEgD,REG(R))|ADR|(n)<<10)
#define NegE(R,n) TEgE,TPxx,EMITW(0x0B000000|MRM(TPxx,TEgE,REG(R))|ADR|(n)<<10)
