...
#define K 2
#define M2 _512
#endif /* RT_SIMD: 128*4, 256*4, 512*4 */
...
#define fmaos_rr(XG, XS, XT)                                                \
        EVX(0,             0, REG(XS), K, 1, 2) EMITB(0xB8)                 \
        MRM(REG(XG), MOD(XT), REG(XT))                                      \
        EVX(1,             1, REH(XS), K, 1, 2) EMITB(0xB8)                 \
        MRM(REG(XG), MOD(XT), REG(XT))                                      \
        EVX(2,             2, REI(XS), K, 1, 2) EMITB(0xB8)                 \
        MRM(REG(XG), MOD(XT), REG(XT))                                      \
        EVX(3,             3, REJ(XS), K, 1, 2) EMITB(0xB8)                 \
        MRM(REG(XG), MOD(XT), REG(XT))
...
#define fmsos_rr(XG, XS, XT)                                                \
        EVX(0,             0, REG(XS), K, 1, 2) EMITB(0xBC)                 \
        MRM(REG(XG), MOD(XT), REG(XT))                                      \
        EVX(1,             1, REH(XS), K, 1, 2) EMITB(0xBC)                 \
        MRM(REG(XG), MOD(XT), REG(XT))                                      \
        EVX(2,             2, REI(XS), K, 1, 2) EMITB(0xBC)                 \
        MRM(REG(XG), MOD(XT), REG(XT))                                      \
        EVX(3,             3, REJ(XS), K, 1, 2) EMITB(0xBC)                 \
        MRM(REG(XG), MOD(XT), REG(XT))
...
#define cvtox_rr(XD, XS)                                                    \
        EVX(0,             0,    0x00, K, 3, 1) EMITB(0x7A)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EVX(1,             1,    0x00, K, 3, 1) EMITB(0x7A)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EVX(2,             2,    0x00, K, 3, 1) EMITB(0x7A)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EVX(3,             3,    0x00, K, 3, 1) EMITB(0x7A)                 \
        MRM(REG(XD), MOD(XS), REG(XS))

#define cvtox_ld(XD, MS, DS)                                                \
    ADR EVX(0,       RXB(MS),    0x00, K, 3, 1) EMITB(0x7A)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR EVX(1,       RXB(MS),    0x00, K, 3, 1) EMITB(0x7A)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VZL(DS)), EMPTY)                                 \
    ADR EVX(2,       RXB(MS),    0x00, K, 3, 1) EMITB(0x7A)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VSL(DS)), EMPTY)                                 \
    ADR EVX(3,       RXB(MS),    0x00, K, 3, 1) EMITB(0x7A)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VTL(DS)), EMPTY)
...
#define cuzos_rr(XD, XS)     /* round towards zero */                       \
        EVX(0,             0,    0x00, K, 0, 1) EMITB(0x78)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EVX(1,             1,    0x00, K, 0, 1) EMITB(0x78)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EVX(2,             2,    0x00, K, 0, 1) EMITB(0x78)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EVX(3,             3,    0x00, K, 0, 1) EMITB(0x78)                 \
        MRM(REG(XD), MOD(XS), REG(XS))

#define cuzos_ld(XD, MS, DS) /* round towards zero */                       \
    ADR EVX(0,       RXB(MS),    0x00, K, 0, 1) EMITB(0x78)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR EVX(1,       RXB(MS),    0x00, K, 0, 1) EMITB(0x78)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VZL(DS)), EMPTY)                                 \
    ADR EVX(2,       RXB(MS),    0x00, K, 0, 1) EMITB(0x78)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VSL(DS)), EMPTY)                                 \
    ADR EVX(3,       RXB(MS),    0x00, K, 0, 1) EMITB(0x78)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VTL(DS)), EMPTY)
...
#define cupos_rr(XD, XS)     /* round towards +inf */                       \
        ERX(0,             0,    0x00, 2, 0, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERX(1,             1,    0x00, 2, 0, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERX(2,             2,    0x00, 2, 0, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERX(3,             3,    0x00, 2, 0, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))
...
#define cumos_rr(XD, XS)     /* round towards -inf */                       \
        ERX(0,             0,    0x00, 1, 0, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERX(1,             1,    0x00, 1, 0, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERX(2,             2,    0x00, 1, 0, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERX(3,             3,    0x00, 1, 0, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))
...
#define cutos_rr(XD, XS)                                                    \
        EVX(0,             0,    0x00, K, 0, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EVX(1,             1,    0x00, K, 0, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EVX(2,             2,    0x00, K, 0, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EVX(3,             3,    0x00, K, 0, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))

#define cutos_ld(XD, MS, DS)                                                \
    ADR EVX(0,       RXB(MS),    0x00, K, 0, 1) EMITB(0x79)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR EVX(1,       RXB(MS),    0x00, K, 0, 1) EMITB(0x79)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VZL(DS)), EMPTY)                                 \
    ADR EVX(2,       RXB(MS),    0x00, K, 0, 1) EMITB(0x79)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VSL(DS)), EMPTY)                                 \
    ADR EVX(3,       RXB(MS),    0x00, K, 0, 1) EMITB(0x79)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VTL(DS)), EMPTY)
...
#define curos_rr(XD, XS, mode)                                              \
        ERX(0,             0, 0x00, RT_SIMD_MODE_##mode&3, 0, 1) EMITB(0x79)\
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERX(1,             1, 0x00, RT_SIMD_MODE_##mode&3, 0, 1) EMITB(0x79)\
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERX(2,             2, 0x00, RT_SIMD_MODE_##mode&3, 0, 1) EMITB(0x79)\
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERX(3,             3, 0x00, RT_SIMD_MODE_##mode&3, 0, 1) EMITB(0x79)\
        MRM(REG(XD), MOD(XS), REG(XS))
...
#define muvox_ld(XD, MS, DS)                                                \
    ADR EVX(0,       RXB(MS),    0x00, 2, 0, 1) EMITB(0x28)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR EVX(1,       RXB(MS),    0x00, 2, 0, 1) EMITB(0x28)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VZL(DS)), EMPTY)                                 \
    ADR EVX(2,       RXB(MS),    0x00, 2, 0, 1) EMITB(0x28)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VSL(DS)), EMPTY)                                 \
    ADR EVX(3,       RXB(MS),    0x00, 2, 0, 1) EMITB(0x28)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VTL(DS)), EMPTY)

#define muvox_st(XS, MD, DD)                                                \
    ADR EVX(0,       RXB(MD),    0x00, 2, 0, 1) EMITB(0x29)                 \
        MRM(REG(XS),    0x02, REG(MD))                                      \
        AUX(SIB(MD), EMITW(VAL(DD)), EMPTY)                                 \
    ADR EVX(1,       RXB(MD),    0x00, 2, 0, 1) EMITB(0x29)                 \
        MRM(REG(XS),    0x02, REG(MD))                                      \
        AUX(SIB(MD), EMITW(VZL(DD)), EMPTY)                                 \
    ADR EVX(2,       RXB(MD),    0x00, 2, 0, 1) EMITB(0x29)                 \
        MRM(REG(XS),    0x02, REG(MD))                                      \
        AUX(SIB(MD), EMITW(VSL(DD)), EMPTY)                                 \
    ADR EVX(3,       RXB(MD),    0x00, 2, 0, 1) EMITB(0x29)                 \
        MRM(REG(XS),    0x02, REG(MD))                                      \
        AUX(SIB(MD), EMITW(VTL(DD)), EMPTY)
...
#define sregs_sa() /* save all SIMD regs, destroys Reax */                  \
        ...
        addxx_ri(Reax, IM(RT_SIMD_WIDTH32_2K8*4))                           \
