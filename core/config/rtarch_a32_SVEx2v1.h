...
#define sqrosMrr(XD, PS, XS)     /* merging-masking only */                 \
        ...
        EMITW(0x658DA000 | MTM(RYG(XD), RYG(XS), REP(PS)))
...
#define sqrosMld(XD, PS, MS, DS) /* merging-masking only */                 \
        ...
        EMITW(0x85804000 | MPM(TmmM,    MOD(MS), VZL(DS), B3(DS), K1(DS)))  \
        EMITW(0x658DA000 | MTM(RYG(XD), TmmM,    REP(PS)))
...
#define sqrosPld(XD, PS, MS, DS)                                            \
        ...
        EMITW(0x658DA000 | MTM(REG(XD), TmmM,    REG(PS)))                  \
        EMITW(0x85804000 | MPM(TmmM,    MOD(MS), VZL(DS), B3(DS), K1(DS)))  \
        EMITW(0x04902000 | MTM(RYG(XD), TmmM,    REP(PS)) | MOD(PS) << 16)  \
        EMITW(0x658DA000 | MTM(RYG(XD), TmmM,    REP(PS)))
...
#define ceqosPrr(PD, XS, XT)                                                \
        ...
        EMITW(0x65806000 | MXM(REP(PD), RYG(XS), RYG(XT)))
...
#define ceqos4ld(PD, PS, XS, MT, DT) /* zeroing-masking only */             \
        ...
        EMITW(0x85804000 | MPM(TmmM,    MOD(MT), VZL(DT), B3(DT), K1(DT)))  \
        EMITW(0x65806000 | MXM(REP(PD), RYG(XS), TmmM) | RYG(PS) << 10)

/* cne (D = S != T ? 1 : 0) */

#define cneosPrr(PD, XS, XT)                                                \
        EMITW(0x65806010 | MXM(REG(PD), REG(XS), REG(XT)))                  \
        EMITW(0x65806010 | MXM(REP(PD), RYG(XS), RYG(XT)))
...
#define cneos4ld(PD, PS, XS, MT, DT) /* zeroing-masking only */             \
        ...
        EMITW(0x85804000 | MPM(TmmM,    MOD(MT), VZL(DT), B3(DT), K1(DT)))  \
        EMITW(0x65806010 | MXM(REP(PD), RYG(XS), TmmM) | REP(PS) << 10)

/* clt (D = S < T ? 1 : 0) */

#define cltosPrr(PD, XS, XT)                                                \
        EMITW(0x65804010 | MXM(REG(PD), REG(XT), REG(XS)))                  \
        EMITW(0x65804010 | MXM(REP(PD), RYG(XT), RYG(XS)))
...
#define cltos4ld(PD, PS, XS, MT, DT) /* zeroing-masking only */             \
        ...
        EMITW(0x85804000 | MPM(TmmM,    MOD(MT), VZL(DT), B3(DT), K1(DT)))  \
        EMITW(0x65804010 | MXM(REP(PD), TmmM,    RYG(XS)) | REP(PS) << 10)

/* cle (D = S <= T ? 1 : 0) */

#define cleosPrr(PD, XS, XT)                                                \
        EMITW(0x65804000 | MXM(REG(PD), REG(XT), REG(XS)))                  \
        EMITW(0x65804000 | MXM(REP(PD), RYG(XT), RYG(XS)))
...
#define cleos4ld(PD, PS, XS, MT, DT) /* zeroing-masking only */             \
        ...
        EMITW(0x85804000 | MPM(TmmM,    MOD(MT), VZL(DT), B3(DT), K1(DT)))  \
        EMITW(0x65804000 | MXM(REP(PD), TmmM,    RYG(XS)) | REP(PS) << 10)

/* cgt (D = S > T ? 1 : 0) */

#define cgtosPrr(PD, XS, XT)                                                \
        EMITW(0x65804010 | MXM(REG(PD), REG(XS), REG(XT)))                  \
        EMITW(0x65804010 | MXM(REP(PD), RYG(XS), RYG(XT)))
...
#define cgtos4ld(PD, PS, XS, MT, DT) /* zeroing-masking only */             \
        ...
        EMITW(0x85804000 | MPM(TmmM,    MOD(MT), VZL(DT), B3(DT), K1(DT)))  \
        EMITW(0x65804010 | MXM(REP(PD), RYG(XS), TmmM) | REP(PS) << 10)

/* cge (D = S >= T ? 1 : 0) */

#define cgeosPrr(PD, XS, XT)                                                \
        EMITW(0x65804000 | MXM(REG(PD), REG(XS), REG(XT)))                  \
        EMITW(0x65804000 | MXM(REP(PD), RYG(XS), RYG(XT)))
...
#define ceqoxPrr(PD, XS, XT)                                                \
        ...
        EMITW(0x2480A000 | MXM(REP(PD), RYG(XS), RYG(XT)))
...
#define ceqox4ld(PD, PS, XS, MT, DT) /* zeroing-masking only */             \
        ...
        EMITW(0x85804000 | MPM(TmmM,    MOD(MT), VZL(DT), B3(DT), K1(DT)))  \
        EMITW(0x2480A000 | MXM(REP(PD), RYG(XS), TmmM) | RYG(PS) << 10)

/* cne (D = S != T ? 1 : 0) */

#define cneoxPrr(PD, XS, XT)                                                \
        EMITW(0x2480A010 | MXM(REG(PD), REG(XS), REG(XT)))                  \
        EMITW(0x2480A010 | MXM(REP(PD), RYG(XS), RYG(XT)))
...
#define cneox4ld(PD, PS, XS, MT, DT) /* zeroing-masking only */             \
        ...
        EMITW(0x85804000 | MPM(TmmM,    MOD(MT), VZL(DT), B3(DT), K1(DT)))  \
        EMITW(0x2480A010 | MXM(REP(PD), RYG(XS), TmmM) | REP(PS) << 10)

/* clt (D = S < T ? 1 : 0), unsigned */

#define cltoxPrr(PD, XS, XT)                                                \
        EMITW(0x24800010 | MXM(REG(PD), REG(XT), REG(XS)))                  \
        EMITW(0x24800010 | MXM(REP(PD), RYG(XT), RYG(XS)))
...
#define cltox4ld(PD, PS, XS, MT, DT) /* zeroing-masking only */             \
        ...
        EMITW(0x85804000 | MPM(TmmM,    MOD(MT), VZL(DT), B3(DT), K1(DT)))  \
        EMITW(0x24800010 | MXM(REP(PD), TmmM,    RYG(XS)) | REP(PS) << 10)

/* clt (D = S < T ? 1 : 0), signed */

#define cltonPrr(PD, XS, XT)                                                \
        EMITW(0x24808010 | MXM(REG(PD), REG(XT), REG(XS)))                  \
        EMITW(0x24808010 | MXM(REP(PD), RYG(XT), RYG(XS)))
...
#define clton4ld(PD, PS, XS, MT, DT) /* zeroing-masking only */             \
        ...
        EMITW(0x85804000 | MPM(TmmM,    MOD(MT), VZL(DT), B3(DT), K1(DT)))  \
        EMITW(0x24808010 | MXM(REP(PD), TmmM,    RYG(XS)) | REP(PS) << 10)

/* cle (D = S <= T ? 1 : 0), unsigned */

#define cleoxPrr(PD, XS, XT)                                                \
        EMITW(0x24800000 | MXM(REG(PD), REG(XT), REG(XS)))                  \
        EMITW(0x24800000 | MXM(REP(PD), RYG(XT), RYG(XS)))
...
#define cleox4ld(PD, PS, XS, MT, DT) /* zeroing-masking only */             \
        ...
        EMITW(0x85804000 | MPM(TmmM,    MOD(MT), VZL(DT), B3(DT), K1(DT)))  \
        EMITW(0x24800000 | MXM(REP(PD), TmmM,    RYG(XS)) | REP(PS) << 10)

/* cle (D = S <= T ? 1 : 0), signed */

#define cleonPrr(PD, XS, XT)                                                \
        EMITW(0x24808000 | MXM(REG(PD), REG(XT), REG(XS)))                  \
        EMITW(0x24808000 | MXM(REP(PD), RYG(XT), RYG(XS)))
...
#define cleon4ld(PD, PS, XS, MT, DT) /* zeroing-masking only */             \
        ...
        EMITW(0x85804000 | MPM(TmmM,    MOD(MT), VZL(DT), B3(DT), K1(DT)))  \
        EMITW(0x24808000 | MXM(REP(PD), TmmM,    RYG(XS)) | REP(PS) << 10)

/* cgt (D = S > T ? 1 : 0), unsigned */

#define cgtoxPrr(PD, XS, XT)                                                \
        EMITW(0x24800010 | MXM(REG(PD), REG(XS), REG(XT)))                  \
        EMITW(0x24800010 | MXM(REP(PD), RYG(XS), RYG(XT)))
...
#define cgtox4ld(PD, PS, XS, MT, DT) /* zeroing-masking only */             \
        ...
        EMITW(0x85804000 | MPM(TmmM,    MOD(MT), VZL(DT), B3(DT), K1(DT)))  \
        EMITW(0x24800010 | MXM(REP(PD), RYG(XS), TmmM) | REP(PS) << 10)

/* cgt (D = S > T ? 1 : 0), signed */

#define cgtonPrr(PD, XS, XT)                                                \
        EMITW(0x24808010 | MXM(REG(PD), REG(XS), REG(XT)))                  \
        EMITW(0x24808010 | MXM(REP(PD), RYG(XS), RYG(XT)))
...
#define cgton4ld(PD, PS, XS, MT, DT) /* zeroing-masking only */             \
        ...
        EMITW(0x85804000 | MPM(TmmM,    MOD(MT), VZL(DT), B3(DT), K1(DT)))  \
        EMITW(0x24808010 | MXM(REP(PD), RYG(XS), TmmM) | REP(PS) << 10)

/* cge (D = S >= T ? 1 : 0), unsigned */

#define cgeoxPrr(PD, XS, XT)                                                \
        EMITW(0x24800000 | MXM(REG(PD), REG(XS), REG(XT)))                  \
        EMITW(0x24800000 | MXM(REP(PD), RYG(XS), RYG(XT)))
...
#define cgeox4ld(PD, PS, XS, MT, DT) /* zeroing-masking only */             \
        ...
        EMITW(0x85804000 | MPM(TmmM,    MOD(MT), VZL(DT), B3(DT), K1(DT)))  \
        EMITW(0x24800000 | MXM(REP(PD), RYG(XS), TmmM) | REP(PS) << 10)

/* cge (D = S >= T ? 1 : 0), signed */

#define cgeonPrr(PD, XS, XT)                                                \
        EMITW(0x24808000 | MXM(REG(PD), REG(XS), REG(XT)))                  \
        EMITW(0x24808000 | MXM(REP(PD), RYG(XS), RYG(XT)))
...
#define cgeon4ld(PD, PS, XS, MT, DT) /* zeroing-masking only */             \
        ...
        EMITW(0x85804000 | MPM(TmmM,    MOD(MT), VZL(DT), B3(DT), K1(DT)))  \
        EMITW(0x24808000 | MXM(REP(PD), RYG(XS), TmmM) | REP(PS) << 10)
...
#define cvtox_rr(XD, XS)                                                    \
        EMITW(0x6595A000 | MXM(REG(XD), REG(XS), 0x00))                     \
        EMITW(0x6595A000 | MXM(RYG(XD), RYG(XS), 0x00))

#define cvtox_ld(XD, MS, DS)                                                \
        AUW(SIB(MS),  EMPTY,  EMPTY,    MOD(MS), VAL(DS), A1(DS), EMPTY2)   \
        EMITW(0x85804000 | MPM(TmmM,    MOD(MS), VAL(DS), B3(DS), K1(DS)))  \
        EMITW(0x6595A000 | MXM(REG(XD), TmmM,    0x00))                     \
        EMITW(0x85804000 | MPM(TmmM,    MOD(MS), VZL(DS), B3(DS), K1(DS)))  \
        EMITW(0x6595A000 | MXM(RYG(XD), TmmM,    0x00))
...
#define cuzos_rr(XD, XS)     /* round towards zero */                       \
        EMITW(0x659DA000 | MXM(REG(XD), REG(XS), 0x00))                     \
        EMITW(0x659DA000 | MXM(RYG(XD), RYG(XS), 0x00))

#define cuzos_ld(XD, MS, DS) /* round towards zero */                       \
        AUW(SIB(MS),  EMPTY,  EMPTY,    MOD(MS), VAL(DS), A1(DS), EMPTY2)   \
        EMITW(0x85804000 | MPM(TmmM,    MOD(MS), VAL(DS), B3(DS), K1(DS)))  \
        EMITW(0x659DA000 | MXM(REG(XD), TmmM,    0x00))                     \
        EMITW(0x85804000 | MPM(TmmM,    MOD(MS), VZL(DS), B3(DS), K1(DS)))  \
        EMITW(0x659DA000 | MXM(RYG(XD), TmmM,    0x00))
