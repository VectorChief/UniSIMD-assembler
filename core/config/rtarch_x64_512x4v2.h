...
#define fmaqs_rr(XG, XS, XT)                                                \
        EVW(0,             0, REG(XS), K, 1, 2) EMITB(0xB8)                 \
        MRM(REG(XG), MOD(XT), REG(XT))                                      \
        EVW(1,             1, REH(XS), K, 1, 2) EMITB(0xB8)                 \
        MRM(REG(XG), MOD(XT), REG(XT))                                      \
        EVW(2,             2, REI(XS), K, 1, 2) EMITB(0xB8)                 \
        MRM(REG(XG), MOD(XT), REG(XT))                                      \
        EVW(3,             3, REJ(XS), K, 1, 2) EMITB(0xB8)                 \
        MRM(REG(XG), MOD(XT), REG(XT))
...
#define fmsqs_rr(XG, XS, XT)                                                \
        EVW(0,             0, REG(XS), K, 1, 2) EMITB(0xBC)                 \
        MRM(REG(XG), MOD(XT), REG(XT))                                      \
        EVW(1,             1, REH(XS), K, 1, 2) EMITB(0xBC)                 \
        MRM(REG(XG), MOD(XT), REG(XT))                                      \
        EVW(2,             2, REI(XS), K, 1, 2) EMITB(0xBC)                 \
        MRM(REG(XG), MOD(XT), REG(XT))                                      \
        EVW(3,             3, REJ(XS), K, 1, 2) EMITB(0xBC)                 \
        MRM(REG(XG), MOD(XT), REG(XT))
...
#define mkjqx_rx(XS, mask, lb)   /* destroys Reax, if S == mask jump lb */  \
        ...
        mk1wx_rx(Reax)                                                      \
        REX(1,             0)                                               \
        EMITB(0x03 | (0x08 << ((RT_SIMD_MASK_##mask##64_2K8 & 0x1) << 1)))  \
        MRM(0x07,       0x03, 0x00)                                         \
...
#define cvnqx_rr(XD, XS)     /* round towards near */                       \
        ...
        fpuzs_st(Mebp,  inf_SCR01(0x78))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0x80))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0x84), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0x80))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0x88))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0x8C), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0x88))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0x90))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0x94), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0x90))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0x98))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0x9C), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0x98))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0xA0))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0xA4), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0xA0))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0xA8))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0xAC), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0xA8))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0xB0))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0xB4), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0xB0))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0xB8))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0xBC), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0xB8))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0xC0))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0xC4), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0xC0))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0xC8))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0xCC), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0xC8))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0xD0))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0xD4), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0xD0))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0xD8))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0xDC), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0xD8))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0xE0))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0xE4), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0xE0))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0xE8))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0xEC), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0xE8))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0xF0))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0xF4), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0xF0))                                    \
        fpuzn_ld(Mebp,  inf_SCR01(0xF8))                                    \
        cmpwx_mi(Mebp,  inf_SCR01(0xFC), IC(0))                             \
        EMITB(0x7D) EMITB(0x07 + x67)                                       \
        addws_ld(Mebp,  inf_SCR02(0x00))                                    \
        fpuzs_st(Mebp,  inf_SCR01(0xF8))                                    \
        movqx_ld(W(XD), Mebp, inf_SCR01(0))
...
#define cuzqs_rr(XD, XS)     /* round towards zero */                       \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0x80))                                    \
        addwx_mi(Mebp,  inf_SCR01(0x84), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0x88))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0x88))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0x88))                                    \
        addwx_mi(Mebp,  inf_SCR01(0x8C), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0x90))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0x90))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0x90))                                    \
        addwx_mi(Mebp,  inf_SCR01(0x94), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0x98))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0x98))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0x98))                                    \
        addwx_mi(Mebp,  inf_SCR01(0x9C), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0xA0))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0xA0))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0xA0))                                    \
        addwx_mi(Mebp,  inf_SCR01(0xA4), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0xA8))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0xA8))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0xA8))                                    \
        addwx_mi(Mebp,  inf_SCR01(0xAC), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0xB0))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0xB0))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0xB0))                                    \
        addwx_mi(Mebp,  inf_SCR01(0xB4), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0xB8))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0xB8))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0xB8))                                    \
        addwx_mi(Mebp,  inf_SCR01(0xBC), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0xC0))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0xC0))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0xC0))                                    \
        addwx_mi(Mebp,  inf_SCR01(0xC4), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0xC8))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0xC8))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0xC8))                                    \
        addwx_mi(Mebp,  inf_SCR01(0xCC), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0xD0))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0xD0))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0xD0))                                    \
        addwx_mi(Mebp,  inf_SCR01(0xD4), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0xD8))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0xD8))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0xD8))                                    \
        addwx_mi(Mebp,  inf_SCR01(0xDC), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0xE0))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0xE0))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0xE0))                                    \
        addwx_mi(Mebp,  inf_SCR01(0xE4), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0xE8))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0xE8))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0xE8))                                    \
        addwx_mi(Mebp,  inf_SCR01(0xEC), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0xF0))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0xF0))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0xF0))                                    \
        addwx_mi(Mebp,  inf_SCR01(0xF4), IW(0x80000000))                    \
        fpuzs_ld(Mebp,  inf_SCR01(0xF8))                                    \
        cmues_xn(1)                                                         \
        EMITB(0x73) EMITB(0x09 + x67)                                       \
        fpuzt_st(Mebp,  inf_SCR01(0xF8))                                    \
        ...
        subes_xn(1)                                                         \
        fpuzt_st(Mebp,  inf_SCR01(0xF8))                                    \
        addwx_mi(Mebp,  inf_SCR01(0xFC), IW(0x80000000))                    \
...
#define cuzqs_rr(XD, XS)     /* round towards zero */                       \
        EVW(0,             0,    0x00, K, 1, 1) EMITB(0x78)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EVW(1,             1,    0x00, K, 1, 1) EMITB(0x78)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EVW(2,             2,    0x00, K, 1, 1) EMITB(0x78)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EVW(3,             3,    0x00, K, 1, 1) EMITB(0x78)                 \
        MRM(REG(XD), MOD(XS), REG(XS))

#define cuzqs_ld(XD, MS, DS) /* round towards zero */                       \
    ADR EVW(0,       RXB(MS),    0x00, K, 1, 1) EMITB(0x78)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR EVW(1,       RXB(MS),    0x00, K, 1, 1) EMITB(0x78)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VZL(DS)), EMPTY)                                 \
    ADR EVW(2,       RXB(MS),    0x00, K, 1, 1) EMITB(0x78)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VSL(DS)), EMPTY)                                 \
    ADR EVW(3,       RXB(MS),    0x00, K, 1, 1) EMITB(0x78)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VTL(DS)), EMPTY)
...
#define cupqs_rr(XD, XS)     /* round towards +inf */                       \
        ERW(0,             0,    0x00, 2, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERW(1,             1,    0x00, 2, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERW(2,             2,    0x00, 2, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERW(3,             3,    0x00, 2, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))
...
#define cumqs_rr(XD, XS)     /* round towards -inf */                       \
        ERW(0,             0,    0x00, 1, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERW(1,             1,    0x00, 1, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERW(2,             2,    0x00, 1, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERW(3,             3,    0x00, 1, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))
...
#define cunqs_rr(XD, XS)     /* round towards near */                       \
        EVW(0,             0,    0x00, K, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EVW(1,             1,    0x00, K, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EVW(2,             2,    0x00, K, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        EVW(3,             3,    0x00, K, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD), MOD(XS), REG(XS))

#define cunqs_ld(XD, MS, DS) /* round towards near */                       \
    ADR EVW(0,       RXB(MS),    0x00, K, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VAL(DS)), EMPTY)                                 \
    ADR EVW(1,       RXB(MS),    0x00, K, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VZL(DS)), EMPTY)                                 \
    ADR EVW(2,       RXB(MS),    0x00, K, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VSL(DS)), EMPTY)                                 \
    ADR EVW(3,       RXB(MS),    0x00, K, 1, 1) EMITB(0x79)                 \
        MRM(REG(XD),    0x02, REG(MS))                                      \
        AUX(SIB(MS), EMITW(VTL(DS)), EMPTY)
...
#define curqs_rr(XD, XS, mode)                                              \
        ERW(0,             0, 0x00, RT_SIMD_MODE_##mode&3, 1, 1) EMITB(0x79)\
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERW(1,             1, 0x00, RT_SIMD_MODE_##mode&3, 1, 1) EMITB(0x79)\
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERW(2,             2, 0x00, RT_SIMD_MODE_##mode&3, 1, 1) EMITB(0x79)\
        MRM(REG(XD), MOD(XS), REG(XS))                                      \
        ERW(3,             3, 0x00, RT_SIMD_MODE_##mode&3, 1, 1) EMITB(0x79)\
        MRM(REG(XD), MOD(XS), REG(XS))
