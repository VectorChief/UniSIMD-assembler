...
#ifndef RT_RTARCH_P32_128X2V2_H
#define RT_RTARCH_P32_128X2V2_H
...
/*
 * rtarch_p32_128x2v2.h: Implementation of Power fp32 VSX1/2 instruction pairs.
 *
...
#if (RT_128X2 >= 1 && RT_128X2 <= 2) && (RT_SIMD_COMPAT_XMM > 0)
