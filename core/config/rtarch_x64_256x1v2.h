...
#define mmvdx_rr(XG, XS)                                                    \
        VEX(RXB(XG), RXB(XS), REN(XG), 1, 1, 3) EMITB(0x4B)                 \
...
#define fmads_rr(XG, XS, XT)                                                \
        VEW(RXB(XG), RXB(XT), REN(XS), 1, 1, 2) EMITB(0xB8)                 \
...
#define fmsds_rr(XG, XS, XT)                                                \
        VEW(RXB(XG), RXB(XT), REN(XS), 1, 1, 2) EMITB(0xBC)                 \
        MRM(REG(XG), MOD(XT), REG(XT))
...
#define mkjdx_rx(XS, mask, lb)   /* destroys Reax, if S == mask jump lb */  \
        VEX(0,       RXB(XS),    0x00, 1, 1, 1) EMITB(0x50)                 \
