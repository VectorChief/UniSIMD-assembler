...
/*
 * rtarch_p64_128x2v8.h: Implementation of Power fp64 VSX1/2 instruction pairs.
 *
...
#define movdx_ld(XD, MS, DS)                                                \
        ...
        EMITW(0x7C000698 | MXM(REG(XD), Teax & M(MOD(MS) == TPxx), TPxx))   \
                                                       /* ^ == -1 if true */
...
#define movdx_st(XS, MD, DD)                                                \
        ...
        EMITW(0x7C000798 | MXM(REG(XS), Teax & M(MOD(MD) == TPxx), TPxx))   \
                                                       /* ^ == -1 if true */
...
#define fmads_ld(XG, XS, MT, DT)                                            \
        ...
        EMITW(0x38000000 | MPM(TPxx,    REG(MT), VAL(DT), B2(DT), P2(DT)))  \
        EMITW(0x7C000699 | MXM(TmmM,    Teax & M(MOD(MT) == TPxx), TPxx))   \
        EMITW(0xF000030F | MXM(REG(XG), REG(XS), TmmM))/* ^ == -1 if true */\
        AUW(EMPTY,    EMPTY,  EMPTY,    MOD(MT), VYL(DT), C2(DT), EMPTY2)   \
        EMITW(0x38000000 | MPM(TPxx,    REG(MT), VYL(DT), B2(DT), P2(DT)))  \
        EMITW(0x7C000699 | MXM(TmmM,    Teax & M(MOD(MT) == TPxx), TPxx))   \
        EMITW(0xF000030A | MXM(REG(XG), REG(XS), TmmM))/* ^ == -1 if true */
...
#define fmsds_ld(XG, XS, MT, DT)                                            \
        ...
        EMITW(0x38000000 | MPM(TPxx,    REG(MT), VAL(DT), B2(DT), P2(DT)))  \
        EMITW(0x7C000699 | MXM(TmmM,    Teax & M(MOD(MT) == TPxx), TPxx))   \
        EMITW(0xF000078F | MXM(REG(XG), REG(XS), TmmM))/* ^ == -1 if true */\
        AUW(EMPTY,    EMPTY,  EMPTY,    MOD(MT), VYL(DT), C2(DT), EMPTY2)   \
        EMITW(0x38000000 | MPM(TPxx,    REG(MT), VYL(DT), B2(DT), P2(DT)))  \
        EMITW(0x7C000699 | MXM(TmmM,    Teax & M(MOD(MT) == TPxx), TPxx))   \
        EMITW(0xF000078A | MXM(REG(XG), REG(XS), TmmM))/* ^ == -1 if true */
