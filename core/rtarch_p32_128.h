...
#define sregs_sa() /* save all SIMD regs, reads and destroys Reax */        \
        ...
        movpx_st(XmmF, Oeax, PLAIN)                                         \
        addxx_ri(Reax, IB(RT_SIMD_WIDTH*4))                                 \
        EMITW(0x7C000719 | MXM(TmmR,    0x00,    Teax))                     \
        addxx_ri(Reax, IB(RT_SIMD_WIDTH*4))                                 \
        EMITW(0x7C000719 | MXM(TmmS,    0x00,    Teax))                     \
        addxx_ri(Reax, IB(RT_SIMD_WIDTH*4))                                 \
        EMITW(0x7C000719 | MXM(TmmQ,    0x00,    Teax))                     \
        addxx_ri(Reax, IB(RT_SIMD_WIDTH*4))                                 \
        EMITW(0x7C000719 | MXM(TmmA,    0x00,    Teax))                     \
        addxx_ri(Reax, IB(RT_SIMD_WIDTH*4))                                 \
        EMITW(0x7C000719 | MXM(TmmB,    0x00,    Teax))                     \
        addxx_ri(Reax, IB(RT_SIMD_WIDTH*4))                                 \
        EMITW(0x7C000719 | MXM(TmmC,    0x00,    Teax))                     \
        addxx_ri(Reax, IB(RT_SIMD_WIDTH*4))                                 \
        EMITW(0x7C000719 | MXM(TmmD,    0x00,    Teax))                     \
        addxx_ri(Reax, IB(RT_SIMD_WIDTH*4))                                 \
...
#define sregs_la() /* load all SIMD regs, reads and destroys Reax */        \
        ...
        movpx_ld(XmmF, Oeax, PLAIN)                                         \
        addxx_ri(Reax, IB(RT_SIMD_WIDTH*4))                                 \
        EMITW(0x7C000619 | MXM(TmmR,    0x00,    Teax))                     \
        addxx_ri(Reax, IB(RT_SIMD_WIDTH*4))                                 \
        EMITW(0x7C000619 | MXM(TmmS,    0x00,    Teax))                     \
        addxx_ri(Reax, IB(RT_SIMD_WIDTH*4))                                 \
        EMITW(0x7C000619 | MXM(TmmQ,    0x00,    Teax))                     \
        addxx_ri(Reax, IB(RT_SIMD_WIDTH*4))                                 \
        EMITW(0x7C000619 | MXM(TmmA,    0x00,    Teax))                     \
        addxx_ri(Reax, IB(RT_SIMD_WIDTH*4))                                 \
        EMITW(0x7C000619 | MXM(TmmB,    0x00,    Teax))                     \
        addxx_ri(Reax, IB(RT_SIMD_WIDTH*4))                                 \
        EMITW(0x7C000619 | MXM(TmmC,    0x00,    Teax))                     \
        addxx_ri(Reax, IB(RT_SIMD_WIDTH*4))                                 \
        EMITW(0x7C000619 | MXM(TmmD,    0x00,    Teax))                     \
        addxx_ri(Reax, IB(RT_SIMD_WIDTH*4))                                 \
        EMITW(0x7C000619 | MXM(TmmE,    0x00,    Teax))                     \
        addxx_ri(Reax, IB(RT_SIMD_WIDTH*4))                                 \
        EMITW(0x7C000619 | MXM(Tmm1,    0x00,    Teax))
